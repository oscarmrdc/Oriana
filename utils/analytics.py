...
def PossibleLM_Service():
    ...
    #service_creations = Event_7045.objects.all().exclude(service__imagepath__icontains="drivers").exclude(service__servicename__contains="AppSense").exclude(service__servicename__contains="Qualys").exclude(service__imagepath__contains="Program Files").exclude(service__servicename__contains="Mandiant")
